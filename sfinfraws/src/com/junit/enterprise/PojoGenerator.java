...
public class PojoGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		Class<?> clazz = PojoGenerator.generate(
				"com.sforce.soap.enterprise.sobject.TestSettings__c", props);
		...
		// set property "bar"
		clazz.getMethod("setTestField__c", String.class).invoke(obj, "Hello World!");

		// get property "bar"
		String result = (String) clazz.getMethod("getTestField__c").invoke(obj);

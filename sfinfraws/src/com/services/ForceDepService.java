...
public class ForceDepService {
	...
	public ForceDepService() {
		...
		String bOrgId = "00D61000000YB04EAG";
		String bOrgToken = "00D61000000YB04!ARMAQEzqgaI2XMAjdqRNrjYsf.udQEoS4JJNPbKT3n328ChmyvavNDEsyQAsbmUE0Kp6.o4ZHrgRIl3JAfMeaQK1OWVL6BYr";
		String bOrgURL = "https://na34.salesforce.com";
		String refreshToken = "5Aep861tbt360sO1.vrCA2niEfjpVBi4p6yJyk8asYbgI1pFhgWfM8.e2ULvouzlfc9T41V84fSIRRa6yQNXItS";
		String releaseParentId = "a0B61000000xkL1EAI";
		
		String releaseParentName = "oct18getPackageTimeTesting";
		...
		//deploy(bOrgId, bOrgToken, bOrgURL, refreshToken, metadataLogId);
		...
		String releasename = "Oct5Release";
		String releaseId = "a0B61000000mnDvEAI";
		String releaseStatus = "Active";
		String metadataLogId = "a0561000000zIFq";
		String packageParentId="a0561000000b1HUAAY";
		//getPackages(bOrgId, bOrgToken, bOrgURL, refreshToken, releaseId, releasename, releaseStatus, metadataLogId);
		updatePackages(bOrgId, bOrgToken, bOrgURL, refreshToken, metadataLogId, "False", packageParentId);
		*/
	...
	public boolean getPackages(String bOrgId, String bOrgToken, String bOrgURL,
		...
		Runnable task;
		try {
			task = new PackagesTask(bOrgId, bOrgToken, bOrgURL,
					bOrgRefreshToken, releaseParentId, releaseParentName,
					releaseStatus, metadataLogId);
			Thread t = new Thread(task);
			t.start();
